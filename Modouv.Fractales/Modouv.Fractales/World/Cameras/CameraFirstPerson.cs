...
namespace Modouv.Fractales.World.Cameras
{
    /// <summary>
    ...
    public class CameraFirstPerson : Camera
    {
        ...
        {
            return Matrix.CreateLookAt(m_position, m_position + m_front, m_up);
        }
        /// <summary>
        ...
        {
            m_front = Vector3.Normalize(Vector3.Transform(m_front,
                                        Matrix.CreateFromAxisAngle(m_up, value)));
            m_needCompute = true;
        ...
        {
            m_up = Vector3.Normalize(Vector3.Transform(m_up,
                                    Matrix.CreateFromAxisAngle(m_front, -value)));
            m_needCompute = true;
        ...
        public void RotateUpDown(float value)
        {
            ...
            m_front = Vector3.Normalize(Vector3.Transform(m_front, Matrix.CreateFromAxisAngle(cameraSide, -value)));
