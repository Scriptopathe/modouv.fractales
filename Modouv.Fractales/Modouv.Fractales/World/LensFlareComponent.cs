...
namespace Modouv.Fractales.World
{
    ...
    public class LensFlareComponent : DrawableGameComponent
    {
        ...
        Flare[] flares =
        {
            new Flare(-0.5f, 0.7f, new Color( 50,  25,  50, 125), "textures\\world_fantasy\\lensflare\\flare1"),
            new Flare( 0.3f, 0.4f, new Color(100, 255, 200, 125), "textures\\world_fantasy\\lensflare\\flare1"),
            new Flare( 1.2f, 1.0f, new Color(100,  50,  50, 175), "textures\\world_fantasy\\lensflare\\flare1"),
            new Flare( 1.5f, 1.5f, new Color( 50, 100,  50, 175), "textures\\world_fantasy\\lensflare\\flare1"),

            new Flare(-0.3f, 0.7f, new Color(200,  50,  50, 150), "textures\\world_fantasy\\lensflare\\flare2"),
            new Flare( 0.6f, 0.9f, new Color( 50, 100,  50, 200), "textures\\world_fantasy\\lensflare\\flare2"),
            new Flare( 0.7f, 0.4f, new Color( 50, 200, 200, 100), "textures\\world_fantasy\\lensflare\\flare2"),

            new Flare(-0.7f, 0.7f, new Color( 50, 100,  25, 140), "textures\\world_fantasy\\lensflare\\flare3"),
            new Flare( 0.0f, 0.6f, new Color( 25,  25,  25, 100), "textures\\world_fantasy\\lensflare\\flare3"),
            new Flare( 2.0f, 1.4f, new Color( 25,  50, 100, 130), "textures\\world_fantasy\\lensflare\\flare3"),
        };
        ...
        protected override void LoadContent()
        {
            ...
            glowSprite = Game.Content.Load<Texture2D>("textures\\world_fantasy\\lensflare\\glow");
        ...
        public void DrawGlow()
        {
            ...
            Color color = glowColor * occlusionAlpha;
            ...
            spriteBatch.Draw(glowSprite, lightPosition, null, color, 0,
                             origin, scale, SpriteEffects.None, 0.5f);
        ...
        public void DrawFlares()
        {
            ...
            foreach (Flare flare in flares)
            {
                ...
                spriteBatch.Draw(flare.Texture, flarePosition, null,
                                 ...
                                 flare.Scale, SpriteEffects.None, 0.5f);
            }
        ...
        BlendState _savedBlend;
        DepthStencilState _savedDepthStencil;
        SamplerState _savedSamplerState = SamplerState.LinearClamp;
        /// <summary>
        /// Sauvegarde les render states avant l'occlusion query.
        /// </summary>
        void SaveRenderStates()
        {
            _savedBlend = GraphicsDevice.BlendState;
            _savedDepthStencil = GraphicsDevice.DepthStencilState;
        ...
        {
            GraphicsDevice.BlendState = _savedBlend;
            GraphicsDevice.DepthStencilState = _savedDepthStencil;
            GraphicsDevice.SamplerStates[0] = _savedSamplerState == null ? SamplerState.LinearClamp : _savedSamplerState;
        }
